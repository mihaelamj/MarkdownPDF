...
Status: active for #85 on branch `feat/85-opentype-shaping-increments` on
2026-06-01. #84 is done through PR #92.
...
flowchart TD
    ...
    S5["Phase 5<br/>#85 Pure Swift shaping increments<br/>Active"]
