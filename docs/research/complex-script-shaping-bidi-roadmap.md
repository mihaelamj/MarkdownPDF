...
Status: #83 is in review through PR #91 on branch
`feat/83-line-break-opportunities` on 2026-06-01.
...
flowchart TD
    ...
    S3["Phase 3<br/>#83 Line-break opportunities<br/>Review and CI"]
