# MarkdownPDF Conventions

The coding conventions for MarkdownPDF. They keep the codebase consistent,
...
Swift for everything. Do not add JavaScript, Python, shell renderers, browser
drivers, PDFKit, CoreGraphics, WebKit, LaTeX, or C Markdown/PDF libraries.
...
MarkdownPDF builds and runs on macOS and Linux.
...
- Guard platform-divergent code and abstract platform-specific dependencies behind
  ...
  Do not use subprocesses for rendering.
